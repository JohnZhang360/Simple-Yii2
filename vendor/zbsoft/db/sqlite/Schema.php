...
namespace zbsoft\db\sqlite;

use zbsoft\exception\NotSupportedException;
use zbsoft\db\Expression;
use zbsoft\db\TableSchema;
use zbsoft\db\ColumnSchema;
use zbsoft\db\Transaction;
 ...
 * @since 2.0
 */
class Schema extends \zbsoft\db\Schema
{
    /**
     ...
     * This can be either [[Transaction::READ_UNCOMMITTED]] or [[Transaction::SERIALIZABLE]].
     * @throws \zbsoft\exception\NotSupportedException when unsupported isolation levels are used.
