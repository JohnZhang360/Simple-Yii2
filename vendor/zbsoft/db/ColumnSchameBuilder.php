...
class ColumnSchemaBuilder extends Object
{
    ...
    /**
     * @var \zbsoft\db\Connection the current database connection. It is used mainly to escape strings
     ...
     * @param \zbsoft\db\Connection $db the current database connection. See [[$db]].
