...
class Command extends Object
{
    ...
    /**
     * @var \zbsoft\caching\Dependency the dependency to be associated with the cached query result for this command
     * @see cache()
     */
     ...
     * @param \zbsoft\caching\Dependency $dependency the cache dependency associated with the cached query result.
     ...
     * @param string $type the column type. [[\zbsoft\db\QueryBuilder::getColumnType()]] will be called
    ...
    protected function queryInternal($method, $fetchMode = null)
    {
        ...
        if ($method !== '') {
            ...
            if (is_array($info)) {
                /* @var $cache \zbsoft\caching\Cache */
                $cache = $info[0];
                $cacheKey = [
                    __CLASS__,
                    $method,
