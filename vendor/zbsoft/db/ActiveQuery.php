...
class ActiveQuery extends Query
{
     ...
     * Order::find()->joinWith([
     *     'books' => function (\zbsoft\db\ActiveQuery $query) {
     ...
     * Customer::find()->with([
     *     'orders' => function (\zbsoft\db\ActiveQuery $query) {
    ...
    private function populateInverseRelation(&$primaryModels, $models, $primaryName, $name)
    {
        ...
        $model = reset($models);
        /* @var $relation ActiveRecord */
        $relation = $model instanceof ActiveRecord ? $model->getRelation($name) : (new $this->modelClass)->getRelation($name);
