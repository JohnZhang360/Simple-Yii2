...
use zbsoft\caching\TagDependency;
...
abstract class Schema extends Object
{
     ...
     */
    public $exceptionMap = [
        'SQLSTATE[23' => 'zbsoft\db\IntegrityException',
    ];
    ...
    /**
     * @return \zbsoft\db\ColumnSchema
     * @throws \zbsoft\exception\InvalidConfigException
     */
    protected function createColumnSchema()
    {
        return Zb::createObject('zbsoft\db\ColumnSchema');
    }
    ...
    public function getTableSchema($name, $refresh = false)
    {
        ...
        if ($db->enableSchemaCache && !in_array($name, $db->schemaCacheExclude, true)) {
            /* @var $cache Cache */
            $cache = is_string($db->schemaCache) ? Zb::$app->get($db->schemaCache, false) : $db->schemaCache;
    ...
    {
        /* @var $cache Cache */
        $cache = is_string($this->db->schemaCache) ? Zb::$app->get($this->db->schemaCache, false) : $this->db->schemaCache;
    ...
    public function convertException(\Exception $e, $rawSql)
    {
        ...
        $exceptionClass = '\zbsoft\db\Exception';
