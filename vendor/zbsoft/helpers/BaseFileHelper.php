...
class BaseFileHelper
{
     ...
     */
    public static $mimeMagicFile = '@zbsoft/helpers/mimeTypes.php';
    ...
    {
        if ($language === null) {
            $language = Zb::$app->language;
        }
        if ($sourceLanguage === null) {
            $sourceLanguage = Zb::$app->sourceLanguage;
        }
    ...
    {
        if ($magicFile !== null) {
            $magicFile = Zb::getAlias($magicFile);
        }
     ...
     * @throws \zbsoft\exception\InvalidParamException if unable to open directory
     */
     ...
     * @throws \zbsoft\exception\InvalidParamException
