...
use zbsoft\base\Request;
use zbsoft\base\UrlManager;
...
class Pagination extends Object
{
    ...
    public $params;
    /**
     * @var UrlManager the URL manager used for creating pagination URLs. If not set,
    ...
    public function createUrl($page, $pageSize = null, $absolute = false)
    {
        ...
        $params[0] = $this->route === null ? Zb::$app->controller->getRoute() : $this->route;
        $urlManager = $this->urlManager === null ? Zb::$app->getUrlManager() : $this->urlManager;
        if ($absolute) {
