...
class BaseStringHelper
{
    ...
    {
        if ($asHtml) {
            return static::truncateHtml($string, $length, $suffix, $encoding ?: Zb::$app->charset);
        }

        if (mb_strlen($string, $encoding ?: Zb::$app->charset) > $length) {
            return trim(mb_substr($string, 0, $length, $encoding ?: Zb::$app->charset)) . $suffix;
        } else {
            return $string;
        }
    }
    ...
    protected static function truncateHtml($string, $count, $suffix, $encoding = false)
    {
        ...
        $config->set('Cache.SerializerPath', \Zb::$app->getRuntimePath());
    ...
    public static function startsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            ...
            return mb_strtolower(mb_substr($string, 0, $bytes, '8bit'), Zb::$app->charset) === mb_strtolower($with, Zb::$app->charset);
        }
    }
    ...
    public static function endsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            ...
            return mb_strtolower(mb_substr($string, -$bytes, mb_strlen($string, '8bit'), '8bit'), Zb::$app->charset) === mb_strtolower($with, Zb::$app->charset);
        }
    }
